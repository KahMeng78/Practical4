...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:SqlDataSource ID="sdsProducts" runat="server" ConnectionString="<%$ ConnectionStrings:NORTHWNDConnectionString %>" SelectCommand="SELECT ProductID, ProductName, CategoryID, UnitPrice FROM Products WHERE (CategoryID = @CategoryID)" OnSelected="sdsProducts_Selected">
                <SelectParameters>
